    ...
    class HomePopUpPlugin : BasePlugin, IWidgetPlugin
    {
        ...
        public override async Task InstallAsync()
        {
            ...
            await _localizationService.AddLocaleResourceAsync(new Dictionary<string, string>
            {
                ...
                ["Plugins.Widgets.HomePopUp.Text"] = "Comment",
                ["Plugins.Widgets.HomePopUp.Text.Hint"] = "Please enter text",
                ["Plugins.Widgets.HomePopUp.Link"] = "URL",
                ["Plugins.Widgets.HomePopUp.Link.Hint"] = "Enter URL. If you don't want the button to be clicked, leave the link empty",
                ["Plugins.Widgets.HomePopUp.Position"] = "Position",
                ["Plugins.Widgets.HomePopUp.Position.Hint"] = "The modal can be on top or in the middle of the page.",
